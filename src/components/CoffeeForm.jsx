...
export default function CoffeeForm(props) {
    ...
    const [showCoffeeeTypes, setShowCoffeeTypes] = useState(false)
        ...
        <>
            ...
            <div className="coffee-grid">
                ...
                <button onClick={() => {
                    ...
                    setSelectedCoffee(null)
                }} className={"button-card " + (showCoffeeeTypes ? 'coffee-button-selected' : '')}>
                    <h4>Other</h4>
                    <p>n/a</p>
                </button>
            </div>
            {showCoffeeeTypes && (
                <select value={selectedCoffee} onChange={(e) => {
